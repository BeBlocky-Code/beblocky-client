  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-3xl border border-border/50 p-6 shadow-2xl duration-200 sm:max-w-lg",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="ring-offset-background focus:ring-ring absolute top-4 right-4 z-20 rounded-full bg-background/80 p-1.5 text-muted-foreground opacity-80 backdrop-blur transition-all hover:bg-muted hover:text-foreground hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
